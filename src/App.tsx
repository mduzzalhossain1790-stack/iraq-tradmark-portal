          ...
          <div className="flex items-center gap-3">
            {isOfficer && (
              <div className="flex items-center space-x-2">
                <span className="text-[10px] font-bold text-indigo-700 bg-indigo-50 border border-indigo-150 px-2 py-1 rounded">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-[10px] font-bold text-red-700 bg-red-50 hover:bg-red-100 border border-red-200 rounded transition cursor-pointer"
                >
                  Logout Staff
                </button>
              </div>
            ...
            <span className={`w-2.5 h-2.5 rounded-full ${hasServerConnection ? "bg-emerald-500 animate-pulse" : "bg-red-500"}`} title={hasServerConnection ? "Ministry Ledger Server Online" : "Disconnected State"} />
          </div>
      ...
      <footer className="w-full text-center border-t border-slate-200 mt-12 py-6 bg-white shrink-0">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-400 text-xs">
          ...
          <div className="flex space-x-4 items-center">
            ...
            <span 
              onClick={() => setShowLoginModal(true)}
              className="font-bold text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded border border-emerald-200 cursor-pointer hover:bg-emerald-100 transition-colors select-none"
            >
              Official Database State Portal
            </span>
          </div>
        </div>
      </footer>
